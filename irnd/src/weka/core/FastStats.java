...
/**
 * Further Modification by Brandon Parker from the original WEKA class
 * 
 * 
...
public class FastStats
  ...
  protected static final double A[] = {
    ...
    protected static final double C[] = {
     ...
     protected static final double Pa[] = {
   ...
   protected static final double P[] = {
     ...
     protected static final double Q[] = {
      //1.0
    ...
    protected static final double T[] = {
   ...
   */
  public final static double binomialStandardError(double p, int n) {
   ...
   */
  public final static double chiSquaredProbability(double x, double v) { 
   ...
   */
  public final static double FProbability(double F, int df1, int df2) {
   ...
   */
  public final static double normalProbability(double a) { 
   ...
   * @return the z-value
   */
  public final static double normalInverse(double y0) { 
   ...
   */
  public final static double lnGamma(double x) {
   ...
   * Math Library (C).
   *
   * @param x a the argument to the function.
   * @return erf value
   */
  public final static double errorFunction(double x) { 
    double y, z;
   ...
   * @return the error function compliment for a
   */
  public final static double errorFunctionComplemented(double a) { 
    double x,y,z,p,q;
   ...
   * @return answer
   */
  public final static double p1evl( double x, double coef[], int N ) {
   ...
   * @return answer
   */
  public final static double polevl( double x, double coef[], int N ) {
   ...
   * @return answer
   */
  public final static double incompleteGamma(double a, double x) 
    { 
   ...
   * @return answer
   */
  public final static double incompleteGammaComplement( double a, double x ) {
   ...
   * @return f(x) ~ Gamma(x)
   */
  public final static double gamma(double x) {
   ...
   * @return answer
   */
  public final static double stirlingFormula(double x) {
   ...
   * @return answer
   */
  public final static double incompleteBeta( double aa, double bb, double xx ) {
   ...
   * @return answer
   */
  public final static double incompleteBetaFraction1( double a, double b, double x ) {
   ...
   * @return answer
   */
  public final static double incompleteBetaFraction2( double a, double b, double x ) {
   ...
   * @return answer
   */
  public final static double powerSeries( double a, double b, double x ) {
